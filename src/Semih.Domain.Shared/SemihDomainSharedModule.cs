...
public class SemihDomainSharedModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<SemihDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<SemihResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Semih");

            options.DefaultResourceType = typeof(SemihResource);
        ...
        {
            options.MapCodeNamespace("Semih", typeof(SemihResource));
        });
    }
}
